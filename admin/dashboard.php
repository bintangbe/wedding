											...
											<div class="panel panel-default">
												<div class="panel-body bk-warning text-light">
													<div class="stat-panel text-center">
														...
														$now = date('Y-m-d');
														$st = "Sudah Dibayar";
														$transaksi = "SELECT id_trx FROM transaksi WHERE stt_trx='Sudah Dibayar'";
														$querypaket = mysqli_query($koneksidb, $transaksi);
														$paket = mysqli_num_rows($querypaket);
														?>
														<div class="stat-panel-number h1 "><?php echo htmlentities($paket); ?></div>
														<div class="stat-panel-title text-uppercase">Data Transaksi</div>
													</div>
												</div>
												<a href="trx.php" class="block-anchor panel-footer text-center">Rincian &nbsp; <i class="fa fa-arrow-right"></i></a>
											</div>
										</div>
									</div>
								</div>
