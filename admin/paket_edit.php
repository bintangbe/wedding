			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Ubah Data Paket</h2>

						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Form Ubah Data Paket</div>
									...
									<div class="form-group">
										<div class="col-sm-4">
											...
											<br/>
											<br/>
											<a href="gambar_paket.php?imgid=<?php echo htmlentities($result['id_paket'])?>" class="btn btn-primary">&nbsp;&nbsp;Ganti Gambar&nbsp;&nbsp;</a></center>
										</div>
									</div>
