						...
						<div class="col-md-12">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">Deksripsi<span style="color:red">*</span></label>
										<div class="col-sm-4">
											<textarea class="form-control"  placeholder="Tulis Deksripsi" name="keterangan" rows="3" required></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="number" min="0" name="harga"  placeholder="Masukkan Nominal Harga" class="form-control" required>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-2 control-label">Gambar<span style="color:red">*</span></label>
										<div class="col-sm-4">
