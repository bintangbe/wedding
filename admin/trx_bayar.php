								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php
										...
										$sqlsewa = "SELECT transaksi.*,paket.*,member.* FROM transaksi, paket, member 
													WHERE transaksi.id_paket=paket.id_paket AND transaksi.username=member.username 
										...
										<tr align="center">
											...
											<td><?php echo htmlentities($result['almt_psng']);?></td>
											...
											<td>
											<a href="trx_bayar_hapus.php?id=<?php echo $result['id_trx'];?>" onclick="return confirm('Apakah anda yakin akan menghapus data <?php echo $result['id_trx'];?>?');"><i class="fa fa-trash"></i> Hapus</a></td>
										</tr>
										<?php }?>
									</tbody>
								</table>
